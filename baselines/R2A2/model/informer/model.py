...
class Informer(nn.Module):
    """ Informer model: this model is used in future prediction, and it is a transformer-based model.
...
#         self.attn = attn
#         self.output_attention = output_attention
#         print('dec_in:{0},d_model:{1}'.format(dec_in,d_model))
#         # Encoding
#         self.enc_embedding = DataEmbedding(enc_in, d_model, embed, freq, dropout)
#         self.dec_embedding = DataEmbedding(dec_in, d_model, embed, freq, dropout)
#         # Attention
...
#         print('InformerStack enc_out.shape:{}'.format(enc_out.shape))
#         dec_out = self.dec_embedding(x_dec, x_mark_dec)
#         print('InformerStack dec_out.shape:{}'.format(dec_out.shape))
#         dec_out = self.decoder(dec_out, enc_out, x_mask=dec_self_mask, cross_mask=dec_enc_mask)
