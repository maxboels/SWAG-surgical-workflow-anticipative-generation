...
class RemainingTimeLoss(nn.Module):
    ...
    """
    def __init__(self, h, beta=1.0, epsilon=1e-6, use_smooth_l1=True, weight_type='linear', alpha=0.1, normalize_weights=False):
        super().__init__()
        self.h = h
        self.beta = beta
    ...
    def forward(self, predictions, targets):
        ...
        if self.use_smooth_l1:
            ...
            base_loss = (norm_predictions - norm_targets) ** 2
